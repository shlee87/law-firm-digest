...
- [ ] Phase 15 — v1.1 Phase Closure Backfills (10/11/11-03 SUMMARY.md + VERIFICATION.md)
- [ ] Phase 16 — v1.1 Metadata Hygiene (REQUIREMENTS checkboxes + `pnpm audit:firms` 신선도 정책)
