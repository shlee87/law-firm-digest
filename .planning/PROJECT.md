...
v1.2 Coverage & Closure 진행 중. v1.1 carry-over:
- [x] Phase 14 — Scheduling Coverage 완료 2026-05-27 (sync-schedule.ts 재작성 대신 삭제 + CLAUDE.md 직접편집 정책 + Monday backfill). 1-week production 관찰 대기 (HUMAN-UAT.md, /gsd:audit-uat에서 surface)
- [x] Phase 15 — v1.1 Phase Closure Backfills 완료 2026-05-27 (10-VERIFICATION.md + 11-VERIFICATION.md + 11-03-SUMMARY.md backfilled retroactively against shipped code, no source changes)
- [x] Phase 16 — v1.1 Metadata Hygiene 완료 2026-05-27 (v1.1-REQUIREMENTS traceability 4-column expand + 6 row flip with pinned evidence, Phase 10/11 SUMMARY frontmatter `requirements-completed:` backfilled, Phase 12 SUMMARYs CONF-06 cross-walk, 06-AUDIT.md regenerated via `pnpm audit:firms` with freshfields row removed, CLAUDE.md `### Audit freshness (audit:firms)` subsection added to ## Conventions block)
